...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.load_referrals_reports = function (page) {
        ...
        if ( $('.settings-page .from-date').val() ) {
            
            var from = Date.parse($('.settings-page .from-date').val());
        ...
        if ( $('.settings-page .to-date').val() ) {
            
            var to = Date.parse($('.settings-page .to-date').val());
    ...
    ********************************/
    ...
    Main.methods.load_referrals_reports = function ( status, data ) { 
        ...
        if ( status === 'success' ) {
            ...
            // Show footer
            $('.settings-page #settings-tab-reports tfoot').show();   
            
            Main.pagination.page = data.page;
            Main.show_pagination('#settings-tab-reports', data.referrals[0].total);
            ...
            $('.settings-page #settings-tab-reports tbody').html(all_referrals);
            ...
            $('.settings-page #settings-tab-reports tbody').html(no_referrals);
            
            // Hide footer
            $('.settings-page #settings-tab-reports tfoot').hide();   
    ...
    Main.methods.load_referrers_list = function ( status, data ) { 
        ...
        if ( status === 'success' ) {
            ...
            // Show footer
            $('.settings-page #settings-tab-payments tfoot').show();   
            
            Main.pagination.page = data.page;
            Main.show_pagination('#settings-tab-payments', data.total);
            ...
            for ( var r = 0; r < data.referrals.length; r++ ) {
                ...
                if ( parseInt(data.referrals[r].earned) > 0 ) {
            ...
            $('.settings-page #settings-tab-payments tbody').html(all_referrals);
            ...
            $('.settings-page #settings-tab-payments tbody').html(no_referrals);
            
            // Hide footer
            $('.settings-page #settings-tab-payments tfoot').hide();  
