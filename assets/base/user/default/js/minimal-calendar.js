...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    $(function () {
        ...
        if ( $('.wrapper .theme-time-picker').length > 0 ) {

            // Identify all time pickers
            $( '.wrapper .theme-time-picker' ).each(function() {
    ...
    $(document).on('click', '#theme-open-time-picker-modal .default-time-set-time', function (e) {
        ...
        if ( parseInt($('#theme-open-time-picker-modal').attr('data-time')) === 1 ) {
            ...
            if ( $('#theme-open-time-picker-modal #theme-time-picker-hours-minutes-select').attr('data-meridiem') ) {
                ...
                // Set meridiem
                $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-meridiem', meridiem);                
            ...
            // Set hour
            $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-hour', hour);
            
            // Set day
            $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-minute', minute);            
        ...
        // Set day
        $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-day', $('#theme-open-time-picker-modal').attr('data-day'));

        // Set month
        $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-month', $('#theme-open-time-picker-modal').attr('data-month'));
        
        // Set year
        $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-year', $('#theme-open-time-picker-modal').attr('data-year'));

        // Set time
        $('.wrapper .theme-time-picker[data-id="' + $(this).closest('#theme-open-time-picker-modal').attr('data-id') + '"]').attr('data-date', get_time).find('span').text(get_time);
