...
jQuery(document).ready( function ($) {
    ...
    ********************************/
    ...
    Main.reload_drag_and_drop_areas = function () {
        ...
        $( '.wrapper .crm-drag-and-drop-files' ).each(function() {
    ...
    ********************************/
    ...
    $(function () {
        ...
        if ( $('.wrapper .crm-drag-and-drop-files').length > 0 ) {
     ...
     * @since   0.0.8.3
    */
    $( document ).on( 'drag dragstart dragend dragover dragenter dragleave drop', '.wrapper .crm-drag-and-drop-files' , function (e) {
        e.preventDefault();
        e.stopPropagation();
    ...
    * @since   0.0.8.3
    */    
    $( document ).on( 'change', '.wrapper .crm-drag-and-drop-files [type="file"]', function (e) {
     ...
     * @since   0.0.8.3
    */
    $( document ).on( 'click', '.wrapper .crm-drag-and-drop-files .crm-choose-files', function (e) {
        e.preventDefault();
    ...
    ********************************/
     ...
     * @since   0.0.8.3
     */
    $(document).on('submit', '.wrapper .crm-upload-files-form', function (e) {
        e.preventDefault();
        ...
        if ( typeof files[0] !== 'undefined' ) {
            ...
            Main.save_files(files, function(files) {
                ...
                // Set the action
                form.append('action', $this.closest('.crm-drag-and-drop-files').attr('data-upload-form-action'));
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if ( data.success === true ) {
                            ...
                            Main.call_object('success', data, $this.closest('.crm-drag-and-drop-files').attr('data-upload-form-action'));
                        
                        } else {
                        
                            // Call the response function and return error message
                            Main.call_object('error', data, $this.closest('.crm-drag-and-drop-files').attr('data-upload-form-action'));
