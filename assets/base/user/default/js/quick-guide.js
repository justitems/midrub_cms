    ...
    ********************************/
    ...
    $( document ).on( 'click', '.wrapper .theme-toggle-quick-guide', function (e) {
        ...
        if ( $( '.wrapper .theme-quick-guide' ).hasClass( 'theme-quick-guide-show' ) ) {
            ...
            if ( ( $( '.wrapper .theme-quick-guide .theme-quick-guide-categories > a' ).length < 1 ) && ( $( '.wrapper .theme-quick-guide .theme-quick-guide-articles > div' ).length < 1 ) ) {
     ...
     * @since   0.0.8.3
     */ 
    $( document ).on( 'click', '.wrapper .theme-quick-guide .theme-quick-guide-categories > .list-group-item, .theme-quick-guide .theme-quick-guide-go-back', function (e) {
        e.preventDefault();
