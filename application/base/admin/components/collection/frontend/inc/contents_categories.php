...
md_set_contents_category(
    ...
    array(
        ...
        'category_icon' => md_the_admin_icon(array('icon' => 'door')),
        'editor' => true,
        'slug_in_url' => true,
        'words_list' => array(
...
if ( !function_exists('md_the_contents_category_word') ) {
    ...
    function md_the_contents_category_word( $word_key ) {
        ...
        if ( isset(md_the_data('contents_category')['words_list'][$word_key]) ) {

            return md_the_data('contents_category')['words_list'][$word_key];
