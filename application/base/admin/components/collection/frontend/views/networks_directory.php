<div class="row mt-3">
   <div class="col-lg-12">
      <div class="theme-box-1">
         <div class="card networks-directory theme-card-box">
            ...
            <div class="card-body">
               ...
               <a href="#" class="default-installation-select-btn theme-button-2">
                  ...
                  <?php echo $this->lang->line('frontend_upload_network'); ?>
               </a>
               <div class="d-none">
                  <?php
                     $attributes = array('class' => 'upload-network', 'id' => 'upload-network', 'method' => 'post', 'data-csrf' => $this->security->get_csrf_token_name());
                     echo form_open_multipart('admin/frontend?p=social_access&group=frontend_page&directory=1', $attributes);
                     ?>
...
<?php md_get_the_file(CMS_BASE_ADMIN_COMPONENTS_FRONTEND . 'views/modals/network_installation.php'); ?>