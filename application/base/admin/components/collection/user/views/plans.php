               ...
               <div class="row">
                        ...
                        <div class="theme-box-1">
                           <div class="row">
                              <div class="col-12">
                                    ...
                                    <input type="text" class="form-control user-search-for-plans" id="user-search-for-plans" placeholder="<?php echo $this->lang->line('user_search_for_plans'); ?>" />
                  ...
                  <div class="col-md-3 col-12">
                        <div class="btn-group theme-box-1 theme-button-new" role="group" aria-label="New Email Template">
                           <a href="#" class="btn btn-secondary theme-background-new theme-font-2" data-bs-toggle="modal" data-bs-target="#new-plan">
                              <?php echo md_the_admin_icon(array('icon' => 'new_plan')); ?>
               ...
               <div class="row">
                  ...
                  <div class="col text-end">
                        <div class="btn-group card-actions-advaced" role="group" aria-label="Actions buttons">
                           <button type="button" class="btn btn-secondary theme-button-1 user-delete-plans">
