...
class Plans_groups {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model( CMS_BASE_ADMIN_COMPONENTS_USER . 'models/', 'User_plans_groups_model', 'user_plans_groups_model' );        
    ...
    public function load_all_plans_groups() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() !== false ) {
                ...
                // Get groups by page
                $get_groups = $this->CI->base_model->the_data_where(
                    'plans_groups',
                    '*',
                    array(),
                    array(),
                ...
                if ( $get_groups ) {
                    ...
                    // Get total groups
                    $groups = $this->CI->base_model->the_data_where(
                        'plans_groups',
