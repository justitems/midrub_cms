...
class Invoices {
    ...
    public function __construct() {
        ...
        $this->CI->load->ext_model(CMS_BASE_PATH . 'models/', 'Base_invoices', 'base_invoices');
    ...
    public function load_payments_invoices() {
        ...
        if ( $this->CI->input->post() ) {
            ...
            if ($this->CI->form_validation->run() !== false ) {
                ...
                $get_invoices = $this->CI->base_model->the_data_where('invoices', 'invoices.invoice_id, invoices.invoice_title, users.user_id, users.username',
                array(),
                array(),
                ...
                array(
                    'order_by' => array('invoices.invoice_id', 'desc'),
                    'start' => ($page * $limit),
                    'limit' => $limit
                ));
                ...
                if ( $get_invoices ) {
                    ...
                    $total = $this->CI->base_model->the_data_where('invoices', 'COUNT(invoices.invoice_id) AS total',
                    array(),
                    array(),
                    array('users.username' => $this->CI->db->escape_like_str($key)),
                    array(array(
