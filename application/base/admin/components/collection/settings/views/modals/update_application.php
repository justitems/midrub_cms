<!-- Modal -->
<div class="modal fade theme-modal" id="settings-update-application" tabindex="-1" role="dialog" aria-labelledby="settings-update-application">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?php echo form_open('admin/settings?q=api-apps', array('class' => 'settings-api-update-application', 'method' => 'post', 'data-csrf' => $this->security->get_csrf_token_name())); ?>
            <div class="modal-header">
                <h5 class="modal-title theme-color-black">
                    <?php echo $this->lang->line('settings_application_info'); ?>
                </h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group mb-3">
                    <label class="theme-label" for="settings-application-id">
                        <?php echo $this->lang->line('settings_application_id'); ?>
                    </label>
                    <input type="text" class="form-control theme-text-input-1 settings-application-id" id="settings-application-id">
                </div>
                <div class="form-group mb-3">
                    <label class="theme-label" for="settings-application-secret">
                        <?php echo $this->lang->line('settings_application_secret'); ?>
                    </label>
                    <input type="text" class="form-control theme-text-input-1 settings-application-secret" id="settings-application-secret">
                </div>
                <div class="row">
                    <div class="col-xs-12">
