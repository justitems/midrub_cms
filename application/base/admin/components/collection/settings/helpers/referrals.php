...
class Referrals {
    ...
    public function load_referrals_reports() {
        ...
        if ( is_numeric($page) ) {
            ...
            $referrals = $this->CI->base_referrals->get_referrals( $page * $limit, $limit, $date_from, $date_to );
    ...
    public function load_referrers_list() {
        ...
        if ( is_numeric($page) ) {
            ...
            // Get referrals by page
            $referrals = $this->CI->base_referrals->get_referrers( $page * $limit, $limit );
            ...
            if ( $referrals ) {
                ...
                $data = array(
                    'success' => TRUE,
                    'referrals' => $referrals,
                    'total' => $this->CI->base_referrals->get_referrers(),
                    'time' => time(),
                    'words' => array(
    ...
    public function referral_pay_gains() {
        ...
        if ( is_numeric($user_id) ) {
            ...
            $referrals = $this->CI->base_referrals->pay_referrers_earns( $user_id );
