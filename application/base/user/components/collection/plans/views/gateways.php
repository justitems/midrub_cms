                ...
                <div class="col-xl-12">
                        ...
                        <div class="panel-heading border-bottom-0">
                            <h3>
                                ...
                                <span class="pull-right discount-price">
                                    <?php echo isset($discount)?'(' . $this->lang->line('plans_discount') . ' ' . $discount . '%)':''; ?>
                                </span>
                            </h3>
                        </div>
                    </div>
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h3>
                                <?php echo $this->lang->line('plans_select_payment_method'); ?>
                            </h3>
                        </div>
                        <div class="panel-body">
                            ...
                            if ( md_the_gateways() ) {
                                ...
                                $options = array(
                                    ...
                                    'success_redirect' => site_url('user/plans'),
                                    'error_redirect' => site_url('user/plans'),
                                ...
                                echo '<li class="no-payments-found">'
                                        . $this->lang->line('plans_no_payments')
                                    . '</li>';
