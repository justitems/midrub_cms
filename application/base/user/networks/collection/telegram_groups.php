...
/**
 * Telegram_groups class - allows users to connect to their Telegram groups
 *
 * @category Social
 * @package  Midrub
 * @author   Scrisoft <asksyn@gmail.com>
 ...
 * @link     https://www.midrub.com/
 */
class Telegram_groups implements CmsBaseUserInterfaces\Networks {
    ...
    public function connect() {
        ...
        if ($this->CI->input->post()) {
                ...
                if ( !empty($data) ) {
                    ...
                    if ( !empty($the_data['result']) ) {
                        ...
                        $params = array(
                            ...
                            'network_name' => 'telegram_groups',
                            'items' => $items,
                            'connect' => $this->CI->lang->line('user_network_groups'),
            ...
            echo $this->CI->load->ext_view(
                ...
                'network_error',
                array(
                    'message' => $this->CI->lang->line('user_network_no_telegram_groups_found')
                ),
                TRUE
            );
            ...
            echo $this->CI->load->ext_view(
                ...
                'network_connect',
                array(
                    'page_title' => $this->CI->lang->line('user_network_connect_telegram_groups'),
                    'callback_url' => site_url('user/connect/telegram_groups'),
                    'fields' => array(
                        array(
                            'slug' => 'bot_token',
    ...
    public function callback($token = null) {
                ...
                if ( isset($the_data['result']) ) {
                    ...
                    for ( $y = 0; $y < count($the_data['result']); $y++ ) {
                        ...
                        if ( $the_connected_group ) {
                            ...
                            // Verify if the Telegram_groups was saved
                            if ( $the_response ) {
                                $check++;
                            }
        ...
        // Verify if at least a Telegram_groups was connected
        if ( $check > 0 ) {
    ...
    public function info() {
        ...
        return array(
            'network_name' => 'Telegram Groups',
            'network_version' => '0.1',
            'network_configuration' => array(
                'fields' => array(
                    array(
                        'field_slug' => 'network_telegram_groups_enabled',
                        'field_type' => 'checkbox',
                        'field_words' => array(
                            'field_title' => 'Enable',
                        ...
                        'field_params' => array(
                            'checked' => md_the_option('network_telegram_groups_enabled')?md_the_option('network_telegram_groups_enabled'):0
                        )
