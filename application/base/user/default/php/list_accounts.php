...
<html lang="en" class="h-100">
    <head>
        <meta charset="utf-8">
        <title><?php echo $this->lang->line('user_networks_connect'); ?> <?php echo ucfirst($connect); ?></title>
    ...
    <body class="d-flex flex-column h-100">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <h6 class="mb-0">
                                    ...
                                    <span class="selected-items"><?php echo $connected_accounts; ?></span> <?php echo $this->lang->line('user_networks_selected'); ?> <?php echo ucfirst($connect); ?>
                                </h6>
                            </div>
                            <div class="col-sm-6">
                                <div class="row">
        ...
        <div class="md-message sube">
            ...
            <?php echo str_replace('[type]', $connect, $this->lang->line('user_networks_reached_maximum_number_of_accounts')); ?>
        </div>
    </body>
