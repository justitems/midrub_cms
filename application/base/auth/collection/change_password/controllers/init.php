...
class Init {
    ...
    public function view() {
        ...
        if (!$this->CI->base_model->the_data_where('users', 'user_id', array(
        ...
        // Set styles
        md_set_css_urls(array('stylesheet', base_url('assets/base/auth/collection/change-password/styles/css/styles.css?ver=' . CMS_BASE_AUTH_CHANGE_PASSWORD_VERSION), 'text/css', 'all'));

        // Set javascript links
        md_set_js_urls(array(base_url('assets/base/auth/collection/change-password/js/main.js?ver=' . CMS_BASE_AUTH_CHANGE_PASSWORD_VERSION)));
