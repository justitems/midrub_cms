...
class Init {
    ...
    public function view() {
        ...
        if ( $this->CI->input->get('plan') ) {
            ...
            if ( $this->CI->base_model->the_data_where('plans', 'plan_id', array('plan_id' => $this->CI->input->get('plan'), 'hidden <' => 1)) ) {
        ...
        $this->CI->template['body'] = $this->CI->load->ext_view(CMS_BASE_AUTH_SIGNUP .  '/views', 'main', array(), true);
