 ...
 * Main Pages Class
 *
 * This file loads the Main Class with properties used to displays pages in the user and administrator panel
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
...
/*
 * Main class loads the general properties used to displays pages in the user and administrator panel
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
