 ...
 * Admin Pages Class
 *
 * This file loads the Admin Class with properties used to displays pages in the user and administrator panel
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
...
/*
 * Admin class loads the general properties used to displays pages in the user and administrator panel
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
