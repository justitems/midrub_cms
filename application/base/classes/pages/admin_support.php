<?php
/**
 * Admin_support Pages Class
 *
 * This file loads the Admin_support Class with properties used to displays pages in the user and administrator panel
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
...
namespace CmsBase\Classes\Pages;

// Constats
defined('BASEPATH') OR exit('No direct script access allowed');

/*
 * Admin_support class loads the general properties used to displays pages in the user and administrator panel
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.8.2
