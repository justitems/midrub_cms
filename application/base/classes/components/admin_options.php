 ...
 * Admin Options Class
 *
 * This file loads the Admin_options Class with properties used to displays components options in the admin panel
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.9
...
/*
 * Admin_options class loads the properties used to displays components options in the admin panel
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.9
