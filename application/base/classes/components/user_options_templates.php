<?php
/**
 * User Options Templates Class
 *
 * This file loads the User_options_templates Class with methods to generates options templates for user's components
 *
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.9
...
/*
 * User_components_templates class loads the methods to generates options templates for user's components
 * 
 * @author Scrisoft
 * @package Midrub
 * @since 0.0.7.9
 */
class User_options_templates {
...
/* End of file user_options_templates.php */