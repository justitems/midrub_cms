<div class="container">
    <div class="payment-container">
        <?php echo form_open('payments/stripe/pay', array('class' => 'process-payment', 'data-transaction' => $transaction_id, 'data-csrf' => $this->security->get_csrf_token_name())); ?>
        <div class="row">
            <div class="col-12">
                <h3>
...
<script language="javascript">
    var words = {
        ...
        public_key: '<?php echo md_the_option('stripe_public_key'); ?>'
    };
</script>