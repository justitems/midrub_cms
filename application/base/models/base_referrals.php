 ...
 * PHP Version 7.4
 *
 * base_referrals file contains the Base Codes Model
 *
 * @category Social
 * @package  Midrub
...
/**
 * Base_referrals class - operates the oauth table.
 *
 * @since 0.0.8.5
 * 
 * @category Social
 ...
 * @link     https://www.midrub.com/
 */
class Base_referrals extends CI_MODEL {
            ...
            foreach ( $results as $result ) {
                ...
                if ( $query->num_rows() > 0 ) {
                    ...
                    foreach ( $earnings as $earning ) {
                        ...
                        $earned = $earned + (float)$earning->earned;
...
/* End of file base_referrals.php */