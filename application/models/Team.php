...
class Team extends CI_MODEL {
     ...
     * @return boolean true or false
     */
    public function update_member( $user_id, $username, $email, $role_id, $status, $about, $password ) {
    ...
    public function get_member( $user_id, $member_id, $member_username=NULL ) {
        ...
        $this->db->select('member_id, member_username, member_email, role_id, status, about_member, UNIX_TIMESTAMP(date_joined) AS date_joined,UNIX_TIMESTAMP(last_access) AS last_access');
        $this->db->from($this->table);
